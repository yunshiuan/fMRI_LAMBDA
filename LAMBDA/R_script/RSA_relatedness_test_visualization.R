#Visualize the relatedness test result [for base models]------------------------------------------
library(stringr)
library(grid)
library(gridExtra)
#Constants----------------------------------------------------------------------
...
DF_RDM_COLOR=data.frame(RDM_name=c("R_V1", "L_V1", "R_IPS", "L_IPS", "R_DLPFC", ################TODO (already done in the "RSA_publication_relatedness_test_visualization.R")
                                   "g",
                                   "agv2","sgv2",
                                   paste0("gagv2",1:9),
                                   paste0("gsgv2",1:9),
...
PATH_RELATEDNESS_BAR_PLOT=file.path(PATH_RSA_CURRENT_TRIAL,
                                    "R_figures","relatedness_test","base_models",
                                     LIST_ACC_VERSION)
#File
