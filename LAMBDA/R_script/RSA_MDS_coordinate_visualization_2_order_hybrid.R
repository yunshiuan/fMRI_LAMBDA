# Representational Similarity Analysis(RSA)[1st order MDS visualization - Hybrid Models]----------------------------------
#Note:
#Including 2nd order MDS visualization with hrbrid model results
...
LIST_HYBRID_MODELS=c("g",
                     "agv2","sgv2",
                     "gagv23","gagv25","gagv27",
                     "gsgv23","gsgv25","gsgv27")
...
DF_RDM_COLOR=data.frame(RDM_name=c("Right V1", "Left V1", "Right IPS", "Left IPS", "Right DLPFC",
                                   "g",
                                   "agv2","sgv2",
                                   paste0("gagv2",c(3,5,7)),
                                   paste0("gsgv2",c(3,5,7)),
                                   "ACC"),
...
df_mds_coordinates=
  df_mds_coordinates%>%
  mutate(RDM_name_as_label=
                case_when(RDM_name=="g" ~ "G-format",
                          
                          RDM_name=="agv2" ~ "log-A",
                          RDM_name=="sgv2" ~ "log-S",
                          
                          RDM_name=="gagv23" ~ "GxA-3",
                          RDM_name=="gagv25" ~ "GxA-5",
                          RDM_name=="gagv27" ~ "GxA-7",
                          
                          RDM_name=="gsgv23" ~ "GxS-3",
                          RDM_name=="gsgv25" ~ "GxS-5",
                          RDM_name=="gsgv27" ~ "GxS-7",
