...
BOOLEAN_PRINT_PARAMETRIC_ANOVA_CSV=T
BOOLEAN_PRINT_ROBUST_ANOVA_CSV=F
...
for (tau_type_index in 1:length(LIST_NAMES_TAU_TYPE)){
  ...
  #All pairs-----------------------------------------------
  list_pariwise_comparison_split_brain_region_age_group_trimmed=c()
  ...
  for (brain_region_index in 1:length(LIST_NAMES_BRAIN_REGION)){
    ...
    names(list_anova_result_split_age_group)=LIST_NAMES_AGE_GROUP
    list_pariwise_comparison_split_brain_region_age_group_trimmed[[brain_region_index]]=list_anova_result_split_age_group
  }
  names(list_pariwise_comparison_split_brain_region_age_group_trimmed)=LIST_NAMES_BRAIN_REGION
