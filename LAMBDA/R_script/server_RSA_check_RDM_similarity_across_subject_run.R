...
dist_functions_names=c("dist_format_without_location_no_distance","dist_format_with_location_no_distance",
                       "dist_only_abs_dist","dist_format_without_location_abs_dist","dist_format_with_location_abs_dist",
                       "dist_only_signed_dist","dist_format_without_location_signed_dist","dist_format_with_location_signed_dist")
weight_dist=0.5 #Only compare the mixed model with weight=0.5 to reduce comparison amount

# file_baseline_df="D:\\Yun-Shiuan_LAMBDA\\EprimeData_raw\\DevFracs1002\\df1002_Run2_tidy.csv"
file_baseline_df="/home/yunshiuan/LAMBDA/EprimeData_raw/DevFracs1002/df1002_Run2_tidy.csv"

# file_valid_run="D:\\GoogleDrive\\Lambda_code\\R_script\\RData\\valid_runs.RData"
file_valid_run="/home/yunshiuan/LAMBDA/R_script/RData/valid_runs.RData"

# path_tidy_csv="D:\\Yun-Shiuan_LAMBDA\\EprimeData_raw"
path_tidy_csv="/home/yunshiuan/LAMBDA/EprimeData_raw"
...
file_RSA_RDM_functions="/home/yunshiuan/LAMBDA/R_script/RData/RSA_RDM_functions.RData"

# file_collect_all_RDMs_all_sub_run="D:\\GoogleDrive\\Lambda_code\\R_script\\RData\\collect_all_RDMs_all_sub_run_valid.RData"
file_collect_all_RDMs_all_sub_run="/home/yunshiuan/LAMBDA/R_script/RData/collect_all_RDMs_all_sub_run_valid.RData"
#Helper functions----------------
...
# collect_all_RDMs_al_sub_run_valid=pbmclapply(temp,
#                                        function(csv){
...
#                                        },mc.cores = 12)
# save(collect_all_RDMs_all_sub_run_valid,file = file_collect_all_RDMs_all_sub_run)

#Quantify the RDM difference across subject run=================================================
load(file_collect_all_RDMs_all_sub_run_valid)
...
for (RDM_type in 1:length(dist_functions_list)){
  ...
  for(RDM_sub_run_index in 1:length(collect_all_RDMs_al_sub_run_valid)){
    RDM_other=collect_all_RDMs_al_sub_run_valid[[RDM_sub_run_index]][[RDM_type]]
    ...
    df_temp=data.frame(abs_diff,spatial_cor$r,spatial_cor$p,
                       names(collect_all_RDMs_al_sub_run_valid)[RDM_sub_run_index],dist_functions_names[RDM_type])
