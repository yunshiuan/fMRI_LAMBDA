...
# ------------------------------------------------------------------------------------
DCM_dir="D:/Yun-Shiuan_LAMBDA/DCM/Part2_DCM_Specify_and_Estimate"
setwd(DCM_dir)
...
list_path_collect_all_id=
  ...
  df_A=
    ...
    mutate(region_to=rep(region_name,length.out=64),
           matrix_type="A")
  ...
  df_C_Near=
    ...
    mutate(region_to=rep(region_name,length.out=8),
           matrix_type="C_Near",
           region_from=NA)
  df_C_Medium=
