%% [Used] Part 1 - iv-3: RSA : Prepare data for RSA usage (before construct RDM) [No run info]
...
RSA_IDs_amount=18;
version_num='5'; %The version number
%files
file_valid_run='D:\Yun-Shiuan_LAMBDA\Run_inclusion_info\inclusive_runs_indexes.csv';
%paths
path_VOI='D:\Yun-Shiuan_LAMBDA\RSA\trial_5_18\Part0-b_VOIs_t_value_extracted_RSA_ID_discrete_repeated_18';
path_RDMs='D:\Yun-Shiuan_LAMBDA\RSA\trial_5_18\Part1_neural_and_conceptual_RDMs_RSA_ID_discrete_repeated_18';
