%% RSA : 2nd order analysis - Hybrid models relatedness test for the tau-profile

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% For tau-profile analysis, all 99 mixed models per combination are included. (2018/6/18)
% The results outputed from this script will be the basis for R to
% visualize the tau profile (cand_r~weights) for each age group x brain
% region.
