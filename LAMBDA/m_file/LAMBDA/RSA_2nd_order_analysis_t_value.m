...
% Constants
% path
path_RDM_result='D:\Yun-Shiuan_LAMBDA\RSA\Part1_neural_and_conceptual_RDMs\RDMs\RDMs_and_options_neural_and_conceptual_trial_3_02-Mar-2018.mat';
path_1st_result='D:\Yun-Shiuan_LAMBDA\RSA\Part2_1st_oder_analysis';
path_2nd_result='D:\Yun-Shiuan_LAMBDA\RSA\Part3_2nd_order_analysis';
version_num='3';
% file
file_1st_user_option=fullfile(path_1st_result,'user_options_visualize_RDM_3_02-Mar-2018.mat');
% Parameters
list_VOI_name={"R_V1","L_V1",...
               "R_IPS","L_IPS"}';
amount_each_format=6;
% Load in needed data
load(path_RDM_result,...
