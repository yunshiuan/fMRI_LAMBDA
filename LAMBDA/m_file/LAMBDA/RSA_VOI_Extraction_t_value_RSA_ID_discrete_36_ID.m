...
% analysis afterwards.
% iii: use t maps (36 trials with repetition using discrete distance)
...
amount_RSA_id=36; % amount of unique RSA id
...
path_t_maps='D:\Yun-Shiuan_LAMBDA\RSA\Part0-a_GLM_estimate_t_value_RSA_ID_discrete_repeated_36';
path_VOI_output='D:\Yun-Shiuan_LAMBDA\RSA\Part0-b_VOIs_t_value_extracted_RSA_ID_discrete_repeated_36';
