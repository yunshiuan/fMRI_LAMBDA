...
% iii: use t maps (36 unique trials with discrete distance) 
...
% Constants
% path
path_RDM_result='D:\Yun-Shiuan_LAMBDA\RSA\Part1_neural_and_conceptual_RDMs_RSA_ID_discrete_repeated_36';
file_RDM_result=fullfile(path_RDM_result,'RDMs','RDMs_and_options_neural_and_conceptual_trial_4_06-Mar-2018');
path_1st_result='D:\Yun-Shiuan_LAMBDA\RSA\Part2_1st_oder_analysis_RSA_ID_discrete_unique_36';
% Parameters
list_VOI_name={"R_V1","L_V1",...
               "R_IPS","L_IPS"}';
amount_each_format=12;
condition_labels=cellstr(string(1:36));
version_num='4';
% Load in needed data
...
user_options_visualize_RDM.conditionColours=[repmat([1 0 0],amount_each_format,1);...
                                             repmat([0 1 0],amount_each_format/2,1);...
                                             repmat([1 0.7 0],amount_each_format/2,1);...
                                             repmat([0 0 1],amount_each_format,1)];
user_options_visualize_RDM.conditionLabels=cellstr(string(1:36));
